...
mkdir docs
# put your index.html there
# in GitHub repo settings → Pages → Source → /docs folder
# your site is live at: yourusername.github.io/vocterm
```
...
├── docs/                ← NEW: GitHub Pages landing page
│   ├── index.html
│   └── demo.gif
...
- [ ] Build landing page in docs/index.html
